...
<v:textbox inset="0px,0px,0px,0px">
<center style="color:#225431; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:16px">
<![endif]--><a href="http://localhost:3000/verify/${email}" target="_blank" style="text-decoration:none;display:inline-block;color:#225431;background-color:transparent;border-radius:5px;width:auto;border-top:2px solid #FFD200;font-weight:400;border-right:2px solid #FFD200;border-bottom:2px solid #FFD200;border-left:2px solid #FFD200;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:35px;padding-right:35px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break:break-word;"><strong><span style="line-height: 28.8px;" data-mce-style>Verify ur account</span></strong></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
															</td>
														</tr>
													</table>
												</td>
